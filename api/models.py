...
class StatsResponse(BaseModel):
    ...
    distribuicao_avaliacoes: Dict[int, int] = Field(..., description="Distribuição de avaliações", alias="distribuicao_avaliacoes")
    ...
    estatisticas_disponibilidade: Dict[str, int] = Field(..., description="Estatísticas de disponibilidade", alias="estatisticas_disponibilidade")
    media_avaliacao_normalizada: float = Field(..., description="Média da avaliação normalizada", alias="media_avaliacao_normalizada")
